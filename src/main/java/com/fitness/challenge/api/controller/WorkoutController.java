...
import com.fitness.challenge.api.service.WorkoutService;
...
public class WorkoutController {
    ...
    @GetMapping("/featured")
    public ResponseEntity<List<Workout>> getFeaturedWorkouts() {
        return ResponseEntity.ok(workoutService.getAllWorkouts()); // For now, return all workouts
    }
